    ...
    <>
      <div class="form-center">
        <form class="forms" onSubmit={formik.handleSubmit}>
          ...
          <div class="mb-1">
            <label for="exampleInputotp1" class="form-label d-flex">
              otp
            </label>
            <input
              name="otp"
            ...
            {formik.touched.otp && formik.errors.otp ? (
              <div class="text-danger">{formik.errors.otp}</div>
            ) : null}
          </div>
          <div class="mb-3">
            <a
              href="/reset/password/mobile/verification"
              class="fs-6 d-flex justify-content-end text-secondary text-decoration-none"
            >
              forgot password
            </a>
          </div>
          {ActiveResponse ? (
            <div class="mb-3" style={{ color: isColor, fontSize: "1px" }}>
              {Messages}
            </div>
          ) : null}
          <div class="mb-3">
